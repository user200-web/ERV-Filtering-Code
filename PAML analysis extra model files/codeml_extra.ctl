seqfile = full_DNA.phy * sequence data file name

outfile = new_extra.out * main result file name

treefile = branch_tree_null.nwk * tree structure file name
...
model = 0 * models for codons: 0:one, 1:b, 2:2 or more dN/dS ratios for branches models for AAs or codon-translated AAs: 0:poisson, 1:proportional,2:Empirical,3:Empirical+F 5:FromCodon0, 6:FromCodon1, 8:REVaa_0, 9:REVaa(nr=189)

NSsites = 0 1 2 3 7 8 * 0:one w;1:neutral;2:selection; 3:discrete;4:freqs;5:gamma;6:2gamma;7:beta;8:beta&w;9:beta&gamma;10:beta&gamma+1; 11:beta&normal>1; 12:0&2normal>1;13:3normal>0
